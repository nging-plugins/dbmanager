...
type Slice_NgingDbSyncLog = factory.Slicex[*NgingDbSyncLog]
...
func (a *NgingDbSyncLog) CtxFrom(source factory.Model) factory.Model {
...
func (a *NgingDbSyncLog) List(recv interface{}, mw func(db.Result) db.Result, page, size int, args ...interface{}) (func() int64, error) {
	...
	if err == nil {
		switch v := recv.(type) {
		case *[]*NgingDbSyncLog:
			err = a.base.FireReaded(a, queryParam, Slice_NgingDbSyncLog(*v))
		case []*NgingDbSyncLog:
			err = a.base.FireReaded(a, queryParam, Slice_NgingDbSyncLog(v))
		case factory.Ranger:
...
func (a *NgingDbSyncLog) Clone() *NgingDbSyncLog {
	cloned := NgingDbSyncLog{Id: a.Id, SyncId: a.SyncId, Created: a.Created, Result: a.Result, ChangeTables: a.ChangeTables, ChangeTableNum: a.ChangeTableNum, Elapsed: a.Elapsed, Failed: a.Failed}
	cloned.CtxFrom(a)
	return &cloned
}
...
func (a *NgingDbSyncLog) Validate(column string, value interface{}) error {
	return a.base.Validate(a, column, value)
}

func (a *NgingDbSyncLog) TrimOverflowText(column string, value string) string {
