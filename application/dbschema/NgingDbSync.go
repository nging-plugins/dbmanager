...
type Slice_NgingDbSync = factory.Slicex[*NgingDbSync]
...
type NgingDbSync struct {
	...
	Updated              int    `db:"updated" bson:"updated" comment:"更新时间" json:"updated" xml:"updated" form_decoder:"time2unix" form_encoder:"unix2time"`
}
...
func (a *NgingDbSync) CtxFrom(source factory.Model) factory.Model {
...
func (a *NgingDbSync) List(recv interface{}, mw func(db.Result) db.Result, page, size int, args ...interface{}) (func() int64, error) {
	...
	if err == nil {
		switch v := recv.(type) {
		case *[]*NgingDbSync:
			err = a.base.FireReaded(a, queryParam, Slice_NgingDbSync(*v))
		case []*NgingDbSync:
			err = a.base.FireReaded(a, queryParam, Slice_NgingDbSync(v))
		case factory.Ranger:
...
func (a *NgingDbSync) Clone() *NgingDbSync {
	cloned := NgingDbSync{Id: a.Id, Name: a.Name, SourceAccountId: a.SourceAccountId, DsnSource: a.DsnSource, DestinationAccountId: a.DestinationAccountId, DsnDestination: a.DsnDestination, Tables: a.Tables, SkipTables: a.SkipTables, AlterIgnore: a.AlterIgnore, Drop: a.Drop, MailTo: a.MailTo, Created: a.Created, Updated: a.Updated}
	cloned.CtxFrom(a)
	return &cloned
}
...
func (a *NgingDbSync) Validate(column string, value interface{}) error {
	return a.base.Validate(a, column, value)
}

func (a *NgingDbSync) TrimOverflowText(column string, value string) string {
